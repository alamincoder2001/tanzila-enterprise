...
<?php } elseif ($module == 'Administration') { ?>
	<ul class="nav nav-list">
		...
		<?php if (
			...
			|| array_search("cash_transfer_list", $access) > -1
			|| array_search("cash_recieve_list", $access) > -1
			|| isset($CheckSuperAdmin) || isset($CheckAdmin)
		) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>" class="dropdown-toggle">
				...
				<ul class="submenu">
					...
					<?php endif; ?>
					<?php if (array_search("cash_transfer_list", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
						<li class="">
							<a href="<?php echo base_url(); ?>cash_transfer_list">
								<i class="menu-icon fa fa-caret-right"></i>
								Cash Transfer List
							</a>
							<b class="arrow"></b>
					...
					<?php if (array_search("cash_recieve_list", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
						<li class="">
							<a href="<?php echo base_url(); ?>cash_recieve_list">
								<i class="menu-icon fa fa-caret-right"></i>
								<span class="menu-text"> Cash Received List</span>
							</a>
							<b class="arrow"></b>
						</li>
					<?php endif; ?>
