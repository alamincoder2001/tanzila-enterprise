	...
	<div class="col-xs-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;margin-bottom:5px;">
		<div class="row">
			...
			<div class="form-group">
				...
				<div class="col-xs-8 col-lg-2">
					<v-select :options="employees" v-model="selectedEmployee" label="Employee_Name" placeholder="Select Employee"></v-select>
				</div>
			</div>
									...
									<tr>
										<td>
											<div class="form-group">
												...
												<div class="col-xs-12">
													<select class="form-control" style="padding: 0;" v-model="sales.payment_type">
									...
									<tr v-if="sales.payment_type == 'Bank'">
										<td>
											<div class="form-group">
												...
												<div class="col-xs-12">
													<v-select :options="bankaccounts" v-model="selectedBank" label="display_name"></v-select>
												</div>
											</div>
										</td>
									</tr>
