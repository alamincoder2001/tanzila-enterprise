...
<div id="products">
		...
		<div class="row" style="margin-top: 10px;margin-bottom:15px;border-bottom: 1px solid #ccc;padding-bottom: 15px;">
			<div class="col-md-6">
				...
				<div class="form-group clearfix" v-if="selectedCategory != null">
					<label class="control-label col-md-4">CategoryWiseDiscount:</label>
					<div class="col-md-7">
						<input type="number" disabled step="0.01" min="0" class="form-control" v-model="selectedCategory.Discount">
					</div>
				</div>
