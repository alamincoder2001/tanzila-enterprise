...
//cash transfer
$route['cash_transfer']        = 'Administrator/Account/cashTransfer';
$route['add_cash_transfer']    = 'Administrator/Account/addCashTransfer';
$route['cash_transfer/(:any)'] = 'Administrator/Account/editCashTransfer/$1';
$route['update_cash_transfer'] = 'Administrator/Account/updateCashTransfer';
$route['delete_cash_transfer'] = 'Administrator/Account/deleteCashTransfer';
$route['get_cash_transfer']   = 'Administrator/Account/getCashTransfer';
$route['cash_transfer_list']   = 'Administrator/Account/CashTransferList';
$route['cash_recieve_list']    = 'Administrator/Account/recieveCashTransfer';
